  ...
  return (
    <div className="min-h-screen bg-zinc-950 font-sans selection:bg-indigo-500/30 text-white">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-1/4 -right-20 w-[500px] h-[500px] bg-indigo-600/20 blur-[120px] rounded-full bg-glow" />
        <div className="absolute bottom-1/4 -left-20 w-[500px] h-[500px] bg-purple-600/20 blur-[120px] rounded-full bg-glow [animation-delay:2s]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-[radial-gradient(circle_at_center,transparent_0%,rgba(0,0,0,0.8)_100%)] opacity-50" />
      </div>
    </div>
  );
}
